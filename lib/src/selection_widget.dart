...
class SelectionWidgetState<T> extends State<SelectionWidget<T>> {
  ...
  void initState() {
    ...
    widget.selectionListViewProps.controller?.addListener(() {
      if (widget.selectionListViewProps.controller!.position.extentAfter == 0) {
        if (widget.paginationCallback != null) {
          widget.paginationCallback!();
        }
      }
    });
                                ...
                                child: Scrollbar(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    addRepaintBoundaries:
                                        widget.selectionListViewProps.addRepaintBoundaries,
                                    addSemanticIndexes:
